...
export default class HomePage extends React.Component{
    constructor() {
        ...
        this.slideChangeleHandler = this.slideChangeleHandler.bind(this)
    }
    slideChangeleHandler(e) {
                ...
                <div className="banner">
                    <div className="carousel">
                        <ul className="slides">
                            ...
                            <input type="radio" name="image-buttons" value="img1" id="img-1" checked={this.state.selected==='img1'} onChange={this.slideChangeleHandler}/>
                            ...
                            <input type="radio" name="image-buttons" value="img2" id="img-2" checked={this.state.selected === 'img2'} onChange={this.slideChangeleHandler.bind(this)} />
                            <li className="slide-container">
                                <div className="slide-image">
                            ...
                            <input type="radio" name="image-buttons" value="img3" id="img-3" checked={this.state.selected === 'img3'} onChange={this.slideChangeleHandler.bind(this)} />
                            <li className="slide-container">
                                <div className="slide-image">
